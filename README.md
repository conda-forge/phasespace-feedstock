...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/phasespace-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8103&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/phasespace-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `phasespace` can be installed with:

```
conda install phasespace
```

It is possible to list all of the versions of `phasespace` available on your platform with:
